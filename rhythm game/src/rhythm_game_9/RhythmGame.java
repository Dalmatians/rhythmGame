...
public class RhythmGame extends JFrame {
	...
	private Image noteRouteImage = new ImageIcon(Main.class.getResource("../images/noteLine.png")).getImage();
	...
	public void screenDraw(Graphics g) { //곡선택창
		...
		if(isGameScreen) { //인게임
			...
			g.drawImage(noteRouteImage, 728, 30, null);
			g.drawImage(noteRouteImage, 866, 30, null);
			g.drawImage(noteRouteImage, 1004, 30, null);
			g.drawImage(noteRouteImage, 1142, 30, null);
			...
			g.drawString("Grievous Lady", 30, 685);
			g.drawString("100%", 600, 685);
			
			g.drawString("Q", 788, 710);
			g.drawString("W", 926, 710);
			g.drawString("P", 1071, 710);
			g.drawString("[", 1209, 710);
		}
